...
function convertToBool(text, fault = 'true') {
    return text === fault ? true : fal
module.exports = {

SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=33RSWRgK#NMBomb10lwvrcGnyrgZsVVha5kM0aKsh7FRW7sUKvW8' : process.env.SESSION_ID,
